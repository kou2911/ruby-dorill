...
def show_data(car)
  ...
  possible_car_ride(car,ride_count)
end
...
def possible_car_ride(car,ride_count)
  if ride_count > car[:capacity]
    puts "#{ride_count - car[:capacity]}人定員オーバーです"
    elsif car[:capacity] < ride_count
      puts "あと#{car[:capacity]-ride_count}人乗ることができます"
      else
        puts "満員です。"  
  end 
end
